...
* **deps:** move resolution overrides to package.json and add missing patches ([#63](https://github.com/forbiddenlink/stancestream/issues/63)) ([e7b01c0](https://github.com/forbiddenlink/stancestream/commit/e7b01c0d1a408ed8946202c81224e3e28a916cda))
...
* broadcast-arena visual system ([01c3d1b](https://github.com/forbiddenlink/stancestream/commit/01c3d1ba40f41dd6fafb775e746a687a41c073e8))
...
* **sentry:** instrument frontend + backend ([7b7a7cc](https://github.com/forbiddenlink/stancestream/commit/7b7a7cc33c1415a5edd150d80810cd6f8bd38f3d))
...
* cap cookie override below v2 to restore @supabase/ssr build ([bd1302f](https://github.com/forbiddenlink/stancestream/commit/bd1302f7535c615edc8dc5ebe720f34b4d0b4a0d))
...
* **deps:** bump security overrides to patched versions ([cbc2719](https://github.com/forbiddenlink/stancestream/commit/cbc2719d3f25201cff2957f3616a2eb205e696a9))
* **deps:** converge security overrides to patched versions ([1638106](https://github.com/forbiddenlink/stancestream/commit/1638106eeb46d0b822fcb7f7b076234d749c583c))
...
* **security:** pin transitive deps to patched versions (Dependabot high alerts) ([6ad9214](https://github.com/forbiddenlink/stancestream/commit/6ad9214eecefb75bd61e1cd4410c44d90646c901))
...
* stop daily Render restart from unhandled Redis socket drops ([42d6e46](https://github.com/forbiddenlink/stancestream/commit/42d6e46adb973a0f801efdf3cb55418641338c87))
* sync frontend lockfile with @sentry/react dependency ([e871993](https://github.com/forbiddenlink/stancestream/commit/e87199378be32234183ca433311c623d3c76e829))
